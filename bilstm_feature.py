...
Trains the model for each (test) fold sequentially, performing a split on the training set
...
if __name__=='__main__':
    '''
    We only need to alter the "feature_type" (string) variable. Choices:
    ...
    For EM-based:
        tweeteval, deepmoji
    For SCD-based:
        scd_op_we, scd_op_sb, scd_fp_we, scd_fp_sb

    For BERT-based models:
        CE: bertnew1_post, bertnew2_post, bertnew3_post, bertnew4_post, bertnew5_post
        Focal: bertnew1_post_focalgamma2alphainversesqrt, ..., bertnew5_post_focalgamma2alphainversesqrt
    '''
    feature_type = 'fsdnn' 
                    ...
                    for units1 in PARAMS_bilstm_tl['num_units_1']:
                        for units2 in [124]:
                            ...
                            if val_score>best_eval_score:
                                ...
                                data_handler.save_results(model, _test_tlids, _test_pids, actual, preds, feature_type, test_fold, use_three_labels, 'bilstm_feature')
